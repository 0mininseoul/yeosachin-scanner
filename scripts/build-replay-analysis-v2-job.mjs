...
const REPLAY_ANALYSIS_V2_JOB_ENTRYPOINTS = Object.freeze({
    ...
    'ai-stage-policy-v2.19': 'scripts/replay-analysis-v219-job.ts',
});
...
function replayJobLocalInputs(evaluationAiPolicy) {
    ...
    if (evaluationAiPolicy === 'ai-stage-policy-v2.19') {
        return REPLAY_ANALYSIS_V219_JOB_LOCAL_INPUTS;
    }
 ...
 *   imageDigest: string;
 *   evaluationAiPolicy?: 'ai-stage-policy-v2.13' | 'ai-stage-policy-v2.14' | 'ai-stage-policy-v2.15' | 'ai-stage-policy-v2.16' | 'ai-stage-policy-v2.17' | 'ai-stage-policy-v2.18' | 'ai-stage-policy-v2.19';
 *   buildImpl?: (
