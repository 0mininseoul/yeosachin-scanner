...
export async function runGenderResolutionE2EQualityCli(
    ...
    const report = Object.freeze({
        ...
        resolverNonterminalAttemptCount: quality.resolverNonterminalAttemptCount,
        ...
        allResolverAttemptsTerminal: quality.allResolverAttemptsTerminal,
        metricsFinalized: quality.metricsFinalized,
        metricsFresh: quality.metricsFresh,
        requestCompleted: quality.requestCompleted,
        standardPlan: quality.standardPlan,
        resultArchivePresent: quality.resultArchivePresent,
        requestGatePassed: quality.requestGatePassed,
