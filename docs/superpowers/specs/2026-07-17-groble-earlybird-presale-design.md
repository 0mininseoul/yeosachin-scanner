...
> 가격 부분은 2026-07-25의 `earlybird-2026-07-v2` forward migration으로 대체되었다.
> 현행 조건은 Basic 기준가 13,900원/결제액 6,900원, Standard 기준가
> 19,900원/결제액 9,900원, 각각 50% 표시와 독립 재고 10건이다. 아래 v1 숫자는
> 최초 계약의 역사적 기록으로만 남긴다.
