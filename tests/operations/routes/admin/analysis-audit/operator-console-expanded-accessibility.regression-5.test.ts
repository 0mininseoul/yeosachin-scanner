...
const css = readFileSync(new URL('../../../../../app/admin/analysis-audit/console.css', import.meta.url), 'utf8');
const workbench = readFileSync(new URL('../../../../../app/admin/analysis-audit/workbench.tsx', import.meta.url), 'utf8');
