...
import { GET } from '../../../../../../../app/api/admin/order-audit/[requestId]/route';

const route = readFileSync(new URL('../../../../../../../app/api/admin/order-audit/[requestId]/route.ts', import.meta.url), 'utf8');
