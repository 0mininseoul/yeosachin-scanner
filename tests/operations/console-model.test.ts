...
describe("order-audit-console-contract", () => {
    ...
    describe('operator console audit payload contracts', () => {
        it('exports strict summary and section row schemas for real RPC payloads', async () => {
            const contractModule = await import('../../lib/services/analysis/order-audit-bundle');
...
describe("order-audit-console-model", () => {
    describe('operator console presentation model', () => {
        it('identifies the first count divergence while leaving unknown counts explicit', async () => {
            const model = await import('../../lib/services/analysis/operator-console-model');
