...
import { createFixturePacket, FIXTURE_ZERO_WORK_SELECTOR_DIGESTS } from '../../../scripts/capacity-identity-epoch/fixtures';
import { EpochCoordinator, type EpochControlPlane, type OperationEvidence } from '../../../scripts/capacity-identity-epoch/coordinator';
import { EpochJournal, type JournalStorage, type StoredObject } from '../../../scripts/capacity-identity-epoch/journal';
import { canonicalDigest, EpochError, type EpochHeader, type State } from '../../../scripts/capacity-identity-epoch/contracts';
import { buildLiveBootstrap, loadProtectedLiveBootstrap } from '../../../scripts/capacity-identity-epoch/bootstrap';
...
import { AuthenticatedProtectedTransport, type ProtectedHttpResponse, type ProtectedTransport } from '../../../scripts/capacity-identity-epoch/platform';
