...
import { deterministicIdentityForSlot, type IdentityGraphObservation } from '../../../../scripts/capacity-identity-epoch/owner-preparation';
import {
    OwnerPreparationOperator,
    parsePreparationCommand,
    type PreparationObservation,
} from '../../../../scripts/capacity-identity-epoch/owner-preparation-operator';
import { EpochError, SLOTS, type Role } from '../../../../scripts/capacity-identity-epoch/contracts';
