...
import { canonicalDigest, type CapacityEpochPacket, type State } from '../../../../scripts/capacity-identity-epoch/contracts';
import {
    prepareProductionEpoch,
    runPreparedThroughVerified,
    verifyProductionOutcome,
    type ProductionVerificationSnapshot,
} from '../../../../scripts/capacity-identity-epoch/operator';
