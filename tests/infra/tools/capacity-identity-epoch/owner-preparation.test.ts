...
} from '../../../../scripts/capacity-identity-epoch/owner-preparation';
import { canonicalDigest, EpochError, SLOTS, type ProtectedIdentity, type Slot } from '../../../../scripts/capacity-identity-epoch/contracts';
