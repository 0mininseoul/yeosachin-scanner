...
} from '../../../../scripts/capacity-identity-epoch/observations';
import { EpochError, canonicalDigest, canonicalRuntimeInputDigest, type ProtectedQueueInput, type ProtectedRuntimeInput, type ProtectedSchedulerInput, type ProtectedRetentionInput } from '../../../../scripts/capacity-identity-epoch/contracts';
