...
import {
    ...
    PrecheckoutDemo,
} from '../../../components/precheckout-demo';
...
describe('PrecheckoutDemo', () => {
    ...
    it('reports a render-boundary error once and exposes an accessible alert', async () => {
        vi.resetModules();
        vi.doMock('../../../components/precheckout-stage-graphs', () => ({
        ...
        const [react, reactDom, brokenModule] = await Promise.all([
            ...
            import('../../../components/precheckout-demo'),
        ]);
        ...
        vi.doUnmock('../../../components/precheckout-stage-graphs');
        vi.resetModules();
    });
