...
import { DEMO_V4_SOURCE_FIXTURE } from '../../../lib/services/demo-analysis/demo-v4-source-fixture';
...
describe('isolated demo fixtures', () => {
    ...
    it('uses only static fixture data at runtime', () => {
        const source = readFileSync(new URL('../../../lib/services/demo-analysis/demo-analysis.ts', import.meta.url), 'utf8');
    ...
    it('keeps the v4 source snapshot self-contained with unique source asset ordinals', () => {
        const source = readFileSync(new URL('../../../lib/services/demo-analysis/demo-v4-source-fixture.ts', import.meta.url), 'utf8');
