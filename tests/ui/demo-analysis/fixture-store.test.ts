...
import { createDemoFixture, REDACTED_BIJECTIVE_DEMO_FIXTURE_VERSION } from '../../../lib/services/demo-analysis/demo-analysis';
...
describe('database demo fixture loader', () => {
    ...
    it('never selects a published v1 payload for a new demo run', async () => {
        ...
        const { loadPublishedDemoFixture } = await import('../../../lib/services/demo-analysis/fixture-store');
