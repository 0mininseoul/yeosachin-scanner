...
vi.mock('../../../lib/services/demo-analysis/fixture-store', () => ({ loadPublishedDemoFixture: mocks.loadPublished }));

import { demoAnalysisStore, demoFixtureIdempotencyKey, isCurrentDemoFixtureRun } from '../../../lib/services/demo-analysis/store';
import { DEMO_FIXTURE_VERSION, REDACTED_DEMO_FIXTURE_VERSION } from '../../../lib/services/demo-analysis/demo-analysis';
