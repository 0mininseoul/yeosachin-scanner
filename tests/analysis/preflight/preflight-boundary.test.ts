...
import type { ClaimedPreflight, PreflightStore } from '../../../lib/services/analysis/preflight';

vi.mock('@/lib/supabase/admin', () => ({ supabaseAdmin: {} }));

import { processPreflight } from '../../../lib/services/analysis/preflight';
import type { PreflightProviderRunStore } from '../../../lib/services/analysis/preflight-provider-run';
...
describe('preflight free-provider boundary', () => {
    ...
    it('keeps count-only self-hosted as primary and does not pay on primary success', async () => {
        const source = readFileSync(new URL('../../../lib/services/analysis/preflight.ts', import.meta.url), 'utf8');
