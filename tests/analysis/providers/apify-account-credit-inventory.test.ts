...
import type { ApifyUserCreditClient } from '../../../lib/services/analysis/beta-apify-credit-pool';
...
describe('all-account Apify credit inventory', () => {
    it('exports the strict all-ten inventory schema for client response validation', async () => {
        const loaded = await import('../../../lib/services/analysis/apify-account-credit-inventory') as unknown as {
