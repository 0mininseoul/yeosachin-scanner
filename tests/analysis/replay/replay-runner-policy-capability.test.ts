...
import { runAnalysisV2AiReplay, type ReplayAiRunner } from '../../../lib/services/analysis/replay/replay-runner';
...
import { parseFeatureConcurrencyExperimentCliCapability } from '../../../lib/services/analysis/replay/feature-concurrency-experiment-capability';
...
describe('replay staged AI runner policy capability', () => {
    ...
    it('exposes no registration capability and cannot retag a genuine adapter', async () => {
        const adapterModule = await import('../../../lib/services/analysis/replay/replay-staged-ai-adapter');
