...
vi.mock('../../../lib/services/analysis/replay/resolver-experiment-ai-adapter', () => ({
...
import { deriveStrongUncertainResolverExperiment } from '../../../lib/services/analysis/replay/resolver-experiment-artifact';
import { runStrongUncertainResolverExperiment } from '../../../lib/services/analysis/replay/resolver-experiment-runner';
import type { ReplayAiRunner, ReplayOutcome } from '../../../lib/services/analysis/replay/replay-runner';
