...
const liveSource = new URL('../../../lib/services/analysis/replay/replay-live-source.ts', import.meta.url);
const stagedAdapter = new URL('../../../lib/services/analysis/replay/replay-staged-ai-adapter.ts', import.meta.url);
const resolverExperimentAdapter =
    new URL('../../../lib/services/analysis/replay/resolver-experiment-ai-adapter.ts', import.meta.url);
const runner = new URL('../../../lib/services/analysis/replay/replay-runner.ts', import.meta.url);
const cli = new URL('../../../scripts/replay-analysis-v2.ts', import.meta.url);
const libRoot = new URL('../../../lib/', import.meta.url);
const replayCapability = new URL('../../../lib/services/ai/replay-stateless-capability.ts', import.meta.url);
const diagnosticPartialCoverageCapability = new URL(
    '../../../lib/services/analysis/replay/diagnostic-partial-coverage-capability.ts',
    import.meta.url,
);
const sourceLineage = new URL('../../../lib/services/analysis/replay/replay-source-lineage.ts', import.meta.url);
