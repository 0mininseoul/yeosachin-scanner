...
function carouselChildDisplayImage(post: NonNullable<AnalysisV2CheckpointProfile['latestPosts']>[number]):
string | undefined {
...
function postDisplayImage(post: NonNullable<AnalysisV2CheckpointProfile['latestPosts']>[number]):
string | undefined {
...
export function selectAnalysisV2ProgressCandidateMedia(
    profile: AnalysisV2CheckpointProfile | null | undefined
