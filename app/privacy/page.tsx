        ...
        <div className="min-h-dvh">
            ...
            <main className="mx-auto max-w-[680px] px-5 py-10">
                ...
                <div className="mt-4 text-[13px] leading-relaxed text-fg-dim [&_li]:mt-1 [&_ul]:mt-1.5 [&_ul]:list-disc [&_ul]:pl-5">
                    ...
                    <p className="mt-2 text-[12px] text-fg-mute">
                        Axiom 운영 로그와 Vercel 런타임 구조화 로그에는 장애 대응·진단에 필요한 내부 UUID와 인스타그램 계정 아이디가 포함될 수 있습니다. 구매자 이름·이메일·전화번호 등 연락처, 댓글, 소개글(bio),
                        ...
                        <table className="min-w-[1180px] border-collapse text-[11px]">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <Td>IP·기기/브라우저 정보, HTTP 요청·응답 메타데이터, 안전한 운영 이벤트·내부 UUID·장애 진단용 인스타그램 계정 아이디</Td><Td>사이트 접속 시 암호화 네트워크 전송</Td>
                                    <Td>호스팅·보안·요청 처리 및 런타임 장애 진단</Td><Td>프로젝트·공급자 로그 설정 및 계약 기간</Td>
