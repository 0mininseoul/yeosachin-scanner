-- Existing fixture versions are replay-only. New demo preflights use v4.
...
BEGIN
    IF p_target_instagram_id !~ '^[A-Za-z0-9._]{1,30}$'
        ...
        RAISE EXCEPTION 'invalid demo v4 run input';
    END IF;
    ...
    WHERE demo_run.user_id = p_user_id
      ...
      AND demo_run.fixture_version = 'authorized-redacted-fixture-v4';
END;
$$;
