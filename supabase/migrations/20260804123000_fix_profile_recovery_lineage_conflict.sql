-- Keep the recovery lineage bridge replayable even though this function has an
-- output column named order_id; verify the immutable row after a no-op insert.
