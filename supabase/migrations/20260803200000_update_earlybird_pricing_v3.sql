-- New checkouts use the v3 Groble amounts. Existing v1/v2 order snapshots
-- remain immutable and replayable while callers refresh an unpurchased
-- preflight into a v3 snapshot.
...
BEGIN
    ...
    IF FOUND THEN
        ...
        IF v_existing.status = 'cancelled' AND v_existing.payment_id IS NULL THEN
            IF v_existing.pricing_version <> 'earlybird-2026-08-v3' THEN
    ...
    END IF;
    IF p_pricing_version <> 'earlybird-2026-08-v3'
       OR v_preflight.pricing_version IN ('earlybird-2026-07-v1', 'earlybird-2026-07-v2') THEN
