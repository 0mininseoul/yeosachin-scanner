-- Fix JSON extraction precedence inside the media-bundle key concatenation.
-- Parenthesizing the extracted text prevents the accumulated text prefix from becoming
-- the left operand of the JSON extraction operator.
